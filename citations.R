...
### SWAN normalization ###
if (normalization) biblib <- c(biblib, citation('minfi')[2])
...
## missMethyl for differential methylation analysis with surrogate variables ##
		biblib <- c(biblib, citation('missMethyl')[2])
	}
